...
I calculate disturbance for two 'sensitivities' from the timber supply model: the 'base case' and 'indigenous a.... f..." sensitivities. These represent two alternative simulations of future forest harvest in the Mackenzie timber supply area.
...
```{r summarize data by area and time - can use for both case case and indigenous, but change output name}
